...
const Index = () => {
  ...
  return (
    <>
      <a href="#main-content" className={`sr-only focus-visible:not-sr-only focus-visible:absolute focus-visible:top-4 ${isRTL ? 'focus-visible:right-4' : 'focus-visible:left-4'} bg-pink-600 text-white px-4 py-2 rounded z-50`}>

...
const qaChecklist: QACheckItem[] = [
  // Branding & Content
  {
    id: 'brand-title',
    category: 'Branding',
    description: 'Site title shows "Beauty Land Card — Discounts & freebies at 12 partner clinics"',
    completed: false,
    critical: true
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2">Beauty Land Card QA Checklist</h1>
        <p className="text-gray-600 mb-4">Complete testing checklist for production deployment</p>
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className={criticalCompleted === criticalTotal ? "text-green-600 font-semibold" : "text-red-600 font-semibold"}>
                {criticalCompleted}/{criticalTotal}
              </span>
            </div>
            <div className="flex justify-between">
              <span>Overall completion:</span>
              <span className="font-semibold">{Math.round((completedCount / checklist.length) * 100)}%</span>
            </div>
            <div className="mt-4 p-3 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">
                <strong>Note:</strong> All critical items must be completed before production deployment.
                Non-critical items can be addressed in follow-up releases.
              </p>
            </div>
          </div>
        </CardContent>

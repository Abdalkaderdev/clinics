...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Buttons: Golden Mustard bg, Dark Charcoal text; hover = Warm Red bg, Cream White text
        default:
          "bg-secondary text-[hsl(0_0%_15%)] hover:bg-primary hover:text-[hsl(42_73%_94%)] shadow-warm hover:shadow-elegant hover:scale-105",
        destructive:

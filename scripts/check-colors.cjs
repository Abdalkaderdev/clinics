...
const problematicPatterns = [
  ...
  { pattern: /text-muted-foreground/g, issue: 'Muted text may have low contrast' },
  { pattern: /text-slate-400/g, issue: 'Light slate text may be hard to read' },
  { pattern: /text-slate-500/g, issue: 'Medium slate text may have contrast issues' },
];
